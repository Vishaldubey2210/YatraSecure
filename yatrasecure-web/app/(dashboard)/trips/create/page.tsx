  ...
  return (
    <div className="anim-in" style={{ maxWidth: 640, margin: '0 auto' }}>
      ...
      {showInviteModal && (
        <div style={{
          ...
          <div style={{
            ...
            >
              <X style={{ width: 18, height: 18, color: 'var(--text3)' }} />
            </button>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 10, color: 'var(--text2)', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 700 }}>
                Invite Code
              </p>
              <p style={{
            ...
            <p style={{ fontSize: 11, color: 'var(--border)', marginTop: 10 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 28 }}>
        ...
        >
          <ArrowLeft style={{ width: 16, height: 16, color: 'var(--text2)' }} />
        </button>
        <div>
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ padding: '32px 36px', display: 'flex', flexDirection: 'column', gap: 24, background: 'var(--card)', borderRadius: 20, border: '1px solid rgba(255,255,255,0.04)' }}>
              ...
              {TRIP_TYPES.map(t => (
                <button
                  ...
                  style={{
                    ...
                    background: tripType === t.value ? 'rgba(255,255,255,1)' : 'var(--border)',
                    borderWidth: 1, borderStyle: 'solid',
                    borderColor: tripType === t.value ? 'transparent' : 'var(--border)',
                    color: tripType === t.value ? 'black' : 'var(--text2)',
                  }}
                >
                  {t.emoji} {t.label}
                </button>
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    background: isPublic === opt.val ? `rgba(${opt.val ? '96,165,250' : '251,191,36'},0.1)` : 'var(--card)',
                    borderWidth: 1, borderStyle: 'solid',
                    borderColor: isPublic === opt.val ? (opt.val ? 'rgba(96,165,250,0.3)' : 'rgba(251,191,36,0.3)') : 'var(--border)',
                  }}
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                    <opt.icon style={{ width: 14, height: 14, color: isPublic === opt.val ? opt.color : 'var(--text3)' }} />
                    <span style={{ fontSize: 13, fontWeight: 700, color: isPublic === opt.val ? opt.color : 'var(--text2)' }}>
                      {opt.label}
                    </span>
                    {isPublic === opt.val && (
                      <span style={{
